...
/**
 * This class is a tester class which is being used to test the working of the Square class by giving sample values to instance variables
 * @author Tarun
 *
 */
...
public class SquareTester {
	...
	{
		Square d = new Square(); // creating a new Square object 
		...
		d.xc = 0; //x-coordinate of the center of the square
		d.yc = 0; //y-coordinate of the center of the square
		...
		d.setVertices(10); // provides the length of the vertices of the square 
