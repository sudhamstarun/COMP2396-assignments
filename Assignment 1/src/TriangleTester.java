...
/**
 * This class is a tester class which is being used to test the working of the Triangle class by giving sample values to instance variables
 * @author Tarun
 *
 */
...
public class TriangleTester {
	...
	{
		Triangle d = new Triangle(); // creating a new Triangle object
		d.color = new Color(0, 0, 0); // setting the color of the shape
		d.filled = true; // defining the type of fill for the shape
